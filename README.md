...
**Rotate (Pump/CGM Tracker)** — a small native iOS app that keeps a journal of your
Omnipod Pod and CGM sensor site placements, suggests four rotation sites when you start
a new Pod (least-recently-used, region-diverse), saves your choice, and reminds you to
continue Pod activation in [Loop](https://github.com/LoopKit/Loop).

This MVP is a polished UI/UX prototype: it has **no** Loop integration, pump communication,
networking, accounts, or HealthKit. Data is stored locally with SwiftData and mirrored to
your private iCloud (CloudKit); with no iCloud account it simply stays on-device, eligible
for your normal encrypted iPhone backup.
...
(`iCloud.consulting.botanica.rotate`). Sync is account-scoped and
